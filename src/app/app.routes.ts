...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./components/promociones/promociones.component').then(m => m.PromocionesComponent),
  },
  {
    path: 'somos',
    canActivate: [authGuard], // Protegida
    ...
    loadComponent: () =>
      import('./components/somos/somos.component').then(m => m.SomosComponent),
  },
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./components/check-in/check-in.component').then(m => m.CheckInComponent),
  },
