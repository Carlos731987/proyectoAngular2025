...
export const routes: Routes = [
  ...
  { path: 'catalogo', component: CatalogoComponent, title: 'Catálogo' }, // ← AGREGAR ESTA LÍNEA
  { path: 'promociones', component: PromocionesComponent, title: 'Promociones' }, // ← AGREGAR ESTA LÍNEA
